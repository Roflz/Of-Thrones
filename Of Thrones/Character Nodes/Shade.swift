...
class Shade: SKSpriteNode, EventListenerNode, InteractiveNode, attackNode {
    ...
    func attack(positions: [CGPoint]) -> SKAction {
        ...
        let move = attack3(position1: attackPositions[0], position2: attackPositions[1], position3: attackPositions[2])
        return move
    }
    ...
    func jump(jumpPoint: CGPoint, position: CGPoint, scene: SKScene) -> SKAction {
